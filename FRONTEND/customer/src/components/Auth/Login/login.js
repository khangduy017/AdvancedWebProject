  ...
  return (
    <div className={`${styles.login} d-flex justify-content-center align-items-center`}>
      <Form onSubmit={submitHandler} className={`${styles['form-size']} shadow rouded p-5 bg-white rounded-3`}>
        ...
        <a href={`${process.env.REACT_APP_API_HOST}auth/google`} type="button" className={`btn mt-3 d-flex gap-1 justify-content-center align-items-center shadow-sm btn-light w-100`}>
