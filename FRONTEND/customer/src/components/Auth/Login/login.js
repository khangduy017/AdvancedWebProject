      ...
      {step === 1 ?
        ...
        <Form onSubmit={submitHandler} className={`${styles['form-size']} shadow rouded p-5 bg-white rounded-3`}>
          ...
          <a href={`${process.env.REACT_APP_API_HOST}auth/google?role=${role}`}
            type="button"
            className={`${styles['social-button']} btn d-flex gap-2 justify-content-center align-items-center btn-light w-100 p-2`}>
